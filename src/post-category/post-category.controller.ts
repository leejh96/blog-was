...
import { CreatePostCtgryReqDto, CreatePostCtgryResDto } from './dto/create-post-category.dto';
...
export class PostCategoryController {
    ...
    async createPostCtgry(@Body() body: CreatePostCtgryReqDto): Promise<CreatePostCtgryResDto>{
        // 카테고리 생성
